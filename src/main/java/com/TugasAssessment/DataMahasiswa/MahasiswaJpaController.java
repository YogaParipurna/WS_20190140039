...
import com.TugasAssessment.DataMahasiswa.exceptions.NonexistentEntityException;
import com.TugasAssessment.DataMahasiswa.exceptions.PreexistingEntityException;
...
public class MahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.TugasAssessment_DataMahasiswa_jar_0.0.1-SNAPSHOTPU");
